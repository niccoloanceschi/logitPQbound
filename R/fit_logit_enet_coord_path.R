...
#' @export
#' 
fit_logit_enet_path <- function(y, X, type=c('NR','BL','PG','PQ'), 
                                beta_start=NULL, lambda=NULL, 
...
#' @export
#' 
fit_logit_enet_cv <- function(y, X, D, type=c('NR','BL','PG','PQ'), 
                              nfold=5, seed=1234, beta_start=NULL, 
                              lambda=NULL, alpha=0.99, eps=0.9, phi=0.9, 
                              gamma=1.0, intercept=FALSE, maxiter=1000L, 
                              abstol=1e-4, reltol=1e-4, etatol=1e-4, 
                              verbose=FALSE, freq=10L) {
  ...
  for (k in 1:nfold) {
    ...
    fit <- fit_logit_enet_path(y[train], X[train,], type=type, 
                               beta_start=beta_start, lambda=lambdak, alpha=alpha,
                               eps=eps, phi=phi, gamma=gamma, intercept=intercept, 
  ...
  fit <- fit_logit_enet_path(y, X, type=type, beta_start=beta_start, 
                             lambda=lambdak, alpha=alpha, eps=eps, phi=phi, 
                             gamma=gamma, intercept=intercept, maxiter=maxiter, 
                             abstol=abstol, reltol=reltol, etatol=etatol, 
                             verbose=FALSE, freq=freq)
